...
def test_triplet_1d_entire_region_with_complete_pixels(
    ...
    snip_strat = Triplet1DSnippingStrategy(
        bin_size=50_000, snipping_value=SnippingValues.ICCF
    )
    # do the snipping
...
def test_triplet_1d_entire_region_with_complete_pixels_from_file(
...
def test_triplet_1d_two_regions_with_complete_pixels(
    complete_synthetic_pixels, two_regions, expected_two_entire_regions_complete
):
    """Test whether snipping of an entire region produces correct results when pixels are supplied as dataframe."""
    # instantiate
    snip_strat = Triplet1DSnippingStrategy(
...
def test_triplet_1d_entire_region_with_incomplete_pixels(
    incomplete_synthetic_pixels, single_region, expected_entire_single_region_incomplete
):
...
def test_triplet_1d_two_regions_with_incomplete_pixels(
    incomplete_synthetic_pixels, two_regions, expected_two_entire_regions_incomplete
):
    """Test whether snipping of an entire region produces correct results."""
    # instantiate
    snip_strat = Triplet1DSnippingStrategy(
